      ...
      <section className="gradient-hero text-white py-16 relative overflow-hidden">
        ...
        <div className="hidden lg:block">
          <FloatingImages images={[
            { src: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=250&q=70", alt: "Doctor", position: "top-6 right-[10%]", size: 110, animation: "animate-float-slow" },
            { src: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=250&q=70", alt: "Specialist", position: "bottom-4 right-[25%]", size: 90, animation: "animate-float-medium", delay: "1s" },
            { src: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=250&q=70", alt: "Consultation", position: "top-10 left-[5%]", size: 80, animation: "animate-drift-x", delay: "1.8s" },
          ]} />
        </div>
